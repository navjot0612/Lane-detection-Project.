...
Open a terminal in the `lane_detection_project` folder.
Install dependencies:
```bash
   pip install -r requirements.txt
   ```
Ensure that the input video is available at `data/input/test_video.mp4`.
Run the project:
```bash
   python src/main.py
   ```
...
Problem statement
Full report content
Diagram descriptions and Mermaid code
Testing plan and GitHub submission checklist
